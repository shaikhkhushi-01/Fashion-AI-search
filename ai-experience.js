...
function aiFashionSvgData(product, model = false) {
  ...
  if (["dress","dresses"].includes(category)) {
    garment=`<path d="M190 215 L230 250 L205 315 L150 610 Q250 670 350 610 L295 315 L270 250 L310 215 L282 175 L250 205 L218 175 Z" fill="${fill}" stroke="#24242a" stroke-width="6"/>`;
